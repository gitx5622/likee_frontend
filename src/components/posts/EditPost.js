...
import { updatePost } from '../../store/posts/actions/postsAction'
    ...
    return (
      ...
      <Modal isOpen={modal} toggle={toggle} className={className}>
        ...
        <ModalBody>
          ...
          <FormGroup>
            <label>Content</label>
            <textarea className="form-control" name="content" style={{
                                                                        width: "100%",
                                                                        height: "150px"
                                                                    }} defaultValue={postUpdate.content} onChange={handleChange}/>
